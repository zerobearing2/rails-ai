...
class MinitestMockingTest < SkillTestCase
  self.skill_domain = "testing"
  self.skill_name = "minitest-mocking"

  def test_skill_file_exists
    assert skill_file_exists?("testing", "minitest-mocking"),
           "minitest-mocking.md should exist in skills/testing/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "minitest-mocking", skill_metadata["name"]
