...
description: Use when setting up Rails 8+ applications - configure SolidQueue, SolidCache, SolidCable for background jobs, caching, WebSockets - NO external dependencies - enforces Team Rule #1 (Solid Stack Only, NEVER Sidekiq/Redis/Memcached)
---
...
- rails-ai:credentials - Secrets and credentials management
- rails-ai:docker - Docker and deployment setup
</related-skills>
