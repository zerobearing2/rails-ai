# Integration Test Scenario: Simple Model Planning

This test evaluates the rails-ai architect agent's ability to plan a Rails model implementation.
...
This is the full prompt to send to the architect agent.
