...
class AntipatternFatControllersTest < SkillTestCase
  ...
  self.skill_name = "antipattern-fat-controllers"

  def test_skill_file_exists
    assert skill_file_exists?("backend", "antipattern-fat-controllers"),
           "antipattern-fat-controllers.md should exist in skills/backend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "antipattern-fat-controllers", skill_metadata["name"]
