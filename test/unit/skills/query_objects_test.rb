...
class QueryObjectsTest < SkillTestCase
  self.skill_domain = "backend"
  self.skill_name = "query-objects"

  def test_skill_file_exists
    assert skill_file_exists?("backend", "query-objects"),
           "query-objects.md should exist in skills/backend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "query-objects", skill_metadata["name"]
