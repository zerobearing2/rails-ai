...
class SecurityFileUploadsTest < SkillTestCase
  self.skill_domain = "security"
  self.skill_name = "security-file-uploads"

  def test_skill_file_exists
    assert skill_file_exists?("security", "security-file-uploads"),
           "security-file-uploads.md should exist in skills/security/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "security-file-uploads", skill_metadata["name"]
