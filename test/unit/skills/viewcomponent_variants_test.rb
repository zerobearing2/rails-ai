...
class ViewcomponentVariantsTest < SkillTestCase
  self.skill_domain = "frontend"
  self.skill_name = "viewcomponent-variants"

  def test_skill_file_exists
    assert skill_file_exists?("frontend", "viewcomponent-variants"),
           "viewcomponent-variants.md should exist in skills/frontend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "viewcomponent-variants", skill_metadata["name"]
