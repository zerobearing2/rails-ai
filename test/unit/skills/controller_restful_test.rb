...
class ControllerRestfulTest < SkillTestCase
  self.skill_domain = "backend"
  self.skill_name = "controller-restful"

  def test_skill_file_exists
    assert skill_file_exists?("backend", "controller-restful"),
           "controller-restful.md should exist in skills/backend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "controller-restful", skill_metadata["name"]
