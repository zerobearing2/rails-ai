...
class DaisyuiComponentsTest < SkillTestCase
  self.skill_domain = "frontend"
  self.skill_name = "daisyui-components"

  def test_skill_file_exists
    assert skill_file_exists?("frontend", "daisyui-components"),
           "daisyui-components.md should exist in skills/frontend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "daisyui-components", skill_metadata["name"]
