---
name: rails-ai:security-strong-params
description: Use when processing user input in Rails controllers - prevents mass assignment vulnerabilities with expect() and require().permit() (CRITICAL security)
---
