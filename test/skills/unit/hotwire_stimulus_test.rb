...
class HotwireStimulusTest < SkillTestCase
  self.skill_domain = "frontend"
  self.skill_name = "hotwire-stimulus"

  def test_skill_file_exists
    assert skill_file_exists?("frontend", "hotwire-stimulus"),
           "hotwire-stimulus.md should exist in skills/frontend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "hotwire-stimulus", skill_metadata["name"]
