...
class ActiverecordPatternsTest < SkillTestCase
  self.skill_domain = "backend"
  self.skill_name = "activerecord-patterns"

  def test_skill_file_exists
    assert skill_file_exists?("backend", "activerecord-patterns"),
           "activerecord-patterns.md should exist in skills/backend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "activerecord-patterns", skill_metadata["name"]
