---
name: rails-ai:credentials
description: Use when managing API keys, passwords, or sensitive configuration - uses Rails encrypted credentials (AES-256) instead of plain-text ENV vars, supports per-environment credentials, safe to commit encrypted files
---
