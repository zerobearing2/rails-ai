---
name: rails-ai:docker
description: Use when setting up Docker for Rails 8+ deployment - configures .dockerignore to exclude development files (docs/, tests/), uses stock Rails 8 Dockerfile patterns, optimizes for Kamal deployment
---
...
- rails-ai:solid-stack - SolidQueue/Cache/Cable configuration
- rails-ai:credentials - Rails encrypted credentials
