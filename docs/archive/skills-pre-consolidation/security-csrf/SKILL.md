---
name: rails-ai:security-csrf
description: Use when building Rails forms and AJAX requests - prevents Cross-Site Request Forgery attacks with authenticity tokens (CRITICAL for session-based auth)
---
