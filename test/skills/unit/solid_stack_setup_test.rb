...
class SolidStackSetupTest < SkillTestCase
  self.skill_domain = "config"
  self.skill_name = "solid-stack-setup"

  def test_skill_file_exists
    assert skill_file_exists?("config", "solid-stack-setup"),
           "solid-stack-setup.md should exist in skills/config/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "solid-stack-setup", skill_metadata["name"]
