---
name: rails-ai:model-testing
description: Use when testing complex Rails models - provides patterns for validations, associations, scopes, callbacks, and edge cases (comprehensive ActiveRecord testing)
---
...
**REQUIRED BACKGROUND:** Use superpowers:test-driven-development for TDD process
  ...
  - This skill provides Rails-specific advanced model testing patterns
</superpowers-integration>
...
- rails-ai:tdd-minitest - TDD workflow basics
- rails-ai:fixtures - Using fixtures effectively
- rails-ai:activerecord-patterns - Model design patterns
</related-skills>
