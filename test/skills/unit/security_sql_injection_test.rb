...
class SecuritySqlInjectionTest < SkillTestCase
  self.skill_domain = "security"
  self.skill_name = "security-sql-injection"

  def test_skill_file_exists
    assert skill_file_exists?("security", "security-sql-injection"),
           "security-sql-injection.md should exist in skills/security/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "security-sql-injection", skill_metadata["name"]
