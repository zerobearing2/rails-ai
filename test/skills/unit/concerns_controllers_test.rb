...
class ConcernsControllersTest < SkillTestCase
  self.skill_domain = "backend"
  self.skill_name = "concerns-controllers"

  def test_skill_file_exists
    assert skill_file_exists?("backend", "concerns-controllers"),
           "concerns-controllers.md should exist in skills/backend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "concerns-controllers", skill_metadata["name"]
