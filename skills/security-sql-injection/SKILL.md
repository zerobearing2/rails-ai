---
name: rails-ai:security-sql-injection
description: Use when writing Rails database queries with user input - prevents SQL injection attacks using parameterized queries and ActiveRecord methods (CRITICAL security)
---
