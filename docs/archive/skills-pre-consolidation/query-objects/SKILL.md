---
name: rails-ai:query-objects
description: Encapsulate complex database queries in reusable, testable, chainable query objects that keep models and controllers clean.
---
...
<related-skills>
- rails-ai:controller-restful - Using query objects in controllers
