---
name: rails-ai:partials
description: Partials are reusable view fragments that help keep your views DRY. Layouts define the overall page structure that wraps your views. Together they create maintainable, consistent UIs.
---
...
<related-skills>
- rails-ai:hotwire-turbo - Turbo Frames use partials for updates
- rails-ai:tailwind - Styling partials with Tailwind
- rails-ai:daisyui - Using DaisyUI in partials
</related-skills>
