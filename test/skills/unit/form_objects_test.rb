...
class FormObjectsTest < SkillTestCase
  self.skill_domain = "backend"
  self.skill_name = "form-objects"

  def test_skill_file_exists
    assert skill_file_exists?("backend", "form-objects"),
           "form-objects.md should exist in skills/backend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "form-objects", skill_metadata["name"]
