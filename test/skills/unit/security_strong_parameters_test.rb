...
class SecurityStrongParametersTest < SkillTestCase
  self.skill_domain = "security"
  self.skill_name = "security-strong-parameters"

  def test_skill_file_exists
    assert skill_file_exists?("security", "security-strong-parameters"),
           "security-strong-parameters.md should exist in skills/security/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "security-strong-parameters", skill_metadata["name"]
