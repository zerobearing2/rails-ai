---
name: rails-ai:nested-resources
description: Organize Rails routes and controllers using nested resource patterns with proper module namespacing and directory structure for parent-child relationships.
---
...
<related-skills>
- rails-ai:controller-restful - Base RESTful controller patterns
- rails-ai:activerecord-patterns - Association and validation patterns
- rails-ai:hotwire-turbo - Turbo frame/stream responses for nested resources
- rails-ai:security-strong-parameters - Secure parameter filtering
</related-skills>
