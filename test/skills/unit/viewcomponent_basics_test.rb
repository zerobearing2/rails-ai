...
class ViewcomponentBasicsTest < SkillTestCase
  self.skill_domain = "frontend"
  self.skill_name = "viewcomponent-basics"

  def test_skill_file_exists
    assert skill_file_exists?("frontend", "viewcomponent-basics"),
           "viewcomponent-basics.md should exist in skills/frontend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "viewcomponent-basics", skill_metadata["name"]
