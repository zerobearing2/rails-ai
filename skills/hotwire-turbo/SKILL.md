---
name: rails-ai:hotwire-turbo
description: Use when building interactive UIs without heavy JavaScript - fast SPA-like navigation and real-time updates using server-rendered HTML - supports Team Rule #7 (Turbo Morph) and Team Rule #13 (Progressive Enhancement)
---
...
<related-skills>
- rails-ai:hotwire-stimulus - Add JavaScript behavior to Turbo interactions
- rails-ai:turbo-morph - Simpler alternative using page refresh with morphing
</related-skills>
