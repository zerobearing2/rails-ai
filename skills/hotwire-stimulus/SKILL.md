---
name: rails-ai:hotwire-stimulus
description: Stimulus is a modest JavaScript framework that connects JavaScript objects to HTML elements using data attributes, enhancing server-rendered HTML.
---
...
<related-skills>
- rails-ai:hotwire-turbo - Stimulus works seamlessly with Turbo
</related-skills>
