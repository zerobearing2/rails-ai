---
name: rails-ai:security-xss
description: Use when displaying ANY user-generated content - prevent malicious JavaScript execution with proper escaping, sanitization, and Content Security Policy - CRITICAL security requirement
---
...
**DANGEROUS:**
```erb
<%# CRITICAL VULNERABILITY - Executes malicious scripts %>
...
- rails-ai:security-strong-params - Strong parameters for mass assignment protection
</related-skills>
