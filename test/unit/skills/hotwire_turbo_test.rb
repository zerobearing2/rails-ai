...
class HotwireTurboTest < SkillTestCase
  self.skill_domain = "frontend"
  self.skill_name = "hotwire-turbo"

  def test_skill_file_exists
    assert skill_file_exists?("frontend", "hotwire-turbo"),
           "hotwire-turbo.md should exist in skills/frontend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "hotwire-turbo", skill_metadata["name"]
