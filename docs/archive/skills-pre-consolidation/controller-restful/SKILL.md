---
name: rails-ai:controller-restful
description: Use when building standard CRUD interfaces - Rails controllers following REST conventions with 7 standard actions, strong parameters, proper HTTP semantics - enforces Team Rule #3 (RESTful Routes Only)
---
...
<related-skills>
- rails-ai:security-strong-params - Secure parameter filtering
- rails-ai:activerecord-patterns - Efficient ActiveRecord patterns
- rails-ai:hotwire-turbo - Turbo Frame/Stream responses
- rails-ai:nested-resources - Complex nested resource patterns
</related-skills>
