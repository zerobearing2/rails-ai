...
class CustomValidatorsTest < SkillTestCase
  ...
  self.skill_name = "custom-validators"

  def test_skill_file_exists
    assert skill_file_exists?("backend", "custom-validators"),
           "custom-validators.md should exist in skills/backend/"
  end
  ...
  def test_has_required_metadata
    ...
    assert_equal "custom-validators", skill_metadata["name"]
