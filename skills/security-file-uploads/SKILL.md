---
name: rails-ai:security-file-uploads
description: Use when accepting file uploads in Rails - prevents path traversal, malicious files, and XSS via uploaded content using ActiveStorage (CRITICAL security)
---
