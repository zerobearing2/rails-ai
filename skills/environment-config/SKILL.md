---
name: rails-ai:environment-config
description: Use when configuring Rails for different environments (development, test, production, staging) - optimizes dev for speed/debugging, test for isolation/determinism, production for performance/security
---
...
<related-skills>
- rails-ai:credentials - Managing encrypted secrets
- rails-ai:initializers - Application initialization
- rails-ai:solid-stack - SolidQueue, SolidCache, SolidCable configuration
</related-skills>
