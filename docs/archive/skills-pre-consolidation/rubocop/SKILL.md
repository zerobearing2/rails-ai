---
name: rails-ai:rubocop
description: Use when customizing Rails RuboCop configuration for team standards - builds on rubocop-rails-omakase (Rails 8 default), enforces TEAM_RULES.md (Rules #16 Double Quotes, #17 bin/ci, #20 Hash#dig), includes custom cops
---
...
- rails-ai:tdd-minitest - Testing workflow (integrates with bin/ci)
- rails-ai:initializers - Code organization standards
