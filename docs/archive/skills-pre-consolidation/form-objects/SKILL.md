---
name: rails-ai:form-objects
description: Encapsulate complex form logic, validation, and data processing using ActiveModel::API without requiring database-backed models.
---
...
<related-skills>
- rails-ai:custom-validators - Custom validations
- rails-ai:controller-restful - Using in controllers
