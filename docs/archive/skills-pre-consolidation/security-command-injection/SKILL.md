---
name: rails-ai:security-command-injection
description: Use when executing system commands in Rails - prevents command injection attacks using array arguments and Ruby alternatives (CRITICAL security)
---
