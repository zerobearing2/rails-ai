...
description: Use when implementing Rails features with Minitest - applies RED-GREEN-REFACTOR with Rails-specific test patterns (fixtures, controller tests, component tests) - enforces Team Rules #2 and #4
---
...
- rails-ai:minitest-mocking - Stubbing and mocking
