---
name: rails-ai:action-mailer
description: Send emails from your Rails application using mailer classes and views. Deliver immediately or via background jobs with SolidQueue.
---
...
<related-skills>
- rails-ai:solid-stack-setup - Using SolidQueue for email delivery

- rails-ai:form-objects - Sending emails from form objects
- rails-ai:tdd-minitest - Testing strategies for mailers
- rails-ai:security-xss - Preventing XSS in email templates
</related-skills>
